...
<script type="text/javascript">
	jQuery(function($) {
		var url = "${ctx}/analysis/namelist?name=all&startTime="+getPreWeek()+"&endTime="+getToDay(); //数据来源
		initDataGrid(url,"{}");
	...
	function select() {
		...
		var getUrl="${ctx}/analysis/namelist?";
		var queryParams={startTime:btime,endTime:etime,name:selectType};
	...
	if(selectType=="全部"||selectType==""){
		...
		var url =  "${ctx}/analysis/downloaddl?name="+selectType+"&startTime="+btime+"&endTime="+etime; 

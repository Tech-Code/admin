...
<script type="text/javascript">
	jQuery(function($) {
		...
		$('#analysistypeTable').datagrid({
			...
			url : "${ctx}/analysis/typelist?type=all&startTime="+getPreMonth(getToDay())+"&endTime="+getToDay(), //数据来源
			sortOrder : 'desc', //倒序
			idField:'id', //主键字段
	...
	function select() {
		...
		$('#analysistypeTable').datagrid({ url:"${ctx}/analysis/typelist?",queryParams:{startTime:btime,endTime:etime,type:selectType},method:"post"});
	}
